...
public class InvoiceService {
    ...
    public byte[] generateInvoicePdf(Long bookingId) {
        try {
            // Generate the rich HTML content first
            String htmlContent = generateInvoicePreview(bookingId);
            
            // For now, return the HTML content as bytes
            // The browser will handle this as a printable HTML document
            // Users can print this as PDF using their browser's print function
