...
# Local PostgreSQL Setup Script for Room Booking App (macOS)
# This script helps set up a local PostgreSQL database for development

echo "🏠 Setting up local PostgreSQL database for Room Booking App (macOS)..."
...
# Create database and user (macOS approach)
psql postgres << EOF
-- Create user
